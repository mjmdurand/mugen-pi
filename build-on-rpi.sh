...
echo iptables-persistent iptables-persistent/autosave_v4 boolean true &>> ${LOG} | sudo debconf-set-selections &>> ${LOG}
echo iptables-persistent iptables-persistent/autosave_v6 boolean true &>> ${LOG} | sudo debconf-set-selections &>> ${LOG}
